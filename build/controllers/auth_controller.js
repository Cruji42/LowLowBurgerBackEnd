...
exports.PasswordRecovery = exports.ResetPassword = exports.Register = exports.Login = void 0;
...
exports.ResetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield database_1.pool.query('UPDATE users SET  password= $1 WHERE email = $2', [password, req.params.email]);
        return res.status(500).json({
